    ...
    if st.button("✅ SUBMIT"):
        ...
        if r.status_code == 200 and data.get("name"):
            ...
            payload = {
                ...
                "body": f"Salam hormat,<br><br>Teriring salam dan rasa hormat yang setinggi-tingginya, kami menyampaikan ucapan terima kasih yang sebesar-besarnya atas kehadiran Bapak/Ibu dalam kegiatan Seminar STRATEGI SUKSES DIMULAI DARI SMA/SMK yang diselenggarakan pada:<br><br>📅 Hari, Tanggal: Kamis, 19 Juni 2025<br>📍 Tempat: Ruang TDC, SMA Plus YPHB<br>🏙️ Alamat: Jalan Pajajaran, Kota <br><br>Partisipasi aktif dan antusiasme Bapak/Ibu dalam mengikuti rangkaian acara menjadi semangat tersendiri bagi kami, Caldera Indonesia dan BMPS Kota Bogor, untuk terus menghadirkan kolaborasi strategis yang memberikan dampak nyata dalam dunia pendidikan, khususnya dalam pengembangan potensi dan perencanaan masa depan siswa-siswi SMA/SMK di era digital saat ini.<br><br>Kami berharap materi yang disampaikan dalam seminar ini dapat memberikan manfaat, wawasan baru, serta inspirasi dalam mendampingi peserta didik agar lebih memahami arah karier dan kompetensinya di tengah perubahan dunia kerja yang semakin cepat dan kompleks.<br><br>Sebagai bentuk apresiasi atas partisipasi Bapak/Ibu, bersama ini kami lampirkan sertifikat keikutsertaan yang dikeluarkan oleh Caldera Indonesia dan BMPS Kota Bogor.<br><br>Semoga kerja sama ini menjadi langkah awal dari sinergi berkelanjutan dalam membangun masa depan pendidikan yang lebih adaptif dan relevan.<br><br>Hormat kami,<br>Tim Caldera Indonesia<br>BMPS Kota Bogor"
            }
